...
"ref=6:ctu=32:bframes=8:rc-lookahead=120:aq-mode=3:aq-strength=0.8:deblock='-3:0':psy-rd=1.2:rdoq-level=0:psy-rdoq=0:tu-intra-depth=4:tu-inter-depth=4:limit-tu=4:rd=5:qg-size=16:me=3:subme=5" \
