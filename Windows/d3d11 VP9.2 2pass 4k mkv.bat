...
ffmpeg -y -hwaccel d3d11va -i "%~1" -af aformat=channel_layouts="7.1|6.1|5.1|stereo" -mapping_family 1 -map 0 libvpx-vp9 -pix_fmt yuv420p10le -b:v 0 -crf 15 -pass 1 -speed 4 -row-mt 1 -an -f matroska NUL && ^ffmpeg -hwaccel d3d11va -i "%~1" -af aformat=channel_layouts="7.1|6.1|5.1|stereo" -mapping_family 1 -map 0 -c:v libvpx-vp9 -pix_fmt yuv420p10le -b:v 0 -crf 15 -auto-alt-ref 1 -lag-in-frames 25 -pass 2 -speed 2 -row-mt 1 -c:a libopus -c:s copy "%~1.%Container%"
shift
goto hugly
:mugly
SET FFREPORT=
